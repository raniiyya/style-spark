...
const HeroSection = () => {
  ...
  return (
  <>
    <section id="hero" className="min-h-screen flex items-center justify-center bg-cream-50 relative overflow-hidden pt-16">
      ...
      <div className="relative z-10 container-luxury text-center">
        ...
        <h1 className="heading-luxury text-7xl md:text-8xl lg:text-9xl mb-8 leading-none">
          <span className="script-text text-6xl md:text-7xl lg:text-8xl">Style</span>
          <br />
        ...
        {/* Impact statement */}
        <div className="mb-12">
          <p className="text-lg md:text-xl mb-4 tracking-[0.2em] display-serif font-normal">
    ...
    <div className="text-center">
      ...
      <p className="body-luxury text-md">Let chance guide your creative journey</p>
    </div>
    ...
    <div className="text-center">
      ...
      <h3 className="subheading-luxury text-lg mb-3">PERSONALIZED INSIGHT</h3>
      <p className="body-luxury text-md">Discover your unique creative preferences</p>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="body-luxury text-md">Explore nine distinct artistic styles</p>
    </div>
  </div>
</>
  );
